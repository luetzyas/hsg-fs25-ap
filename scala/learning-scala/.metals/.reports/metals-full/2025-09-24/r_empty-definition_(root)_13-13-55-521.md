error id: file:///D:/HSG/hsg-fs25-ap/scala/learning-scala/src/main/scala/scala/Overview.scala:local151
...
object Overview:
  ...
  @main def scalaLists() =
    ...
    val l3 = 1 :: 2 :: 3 :: Nil // right associative
    println(s"l1: $l1 \nl2: $l2 \nl3: $l3")
